    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        lv.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                String rid = ((TextView) view.findViewById(R.id.pid)).getText()
                        .toString();
                String rname = ((TextView) view.findViewById(R.id.name)).getText()
                        .toString();
                Log.d("receiver is: ", rid);
                
                // Starting new intent
                Intent in = new Intent(getApplicationContext(),
                        SendMessage.class);
                // sending pid to next activity
                in.putExtra(TAG_RECEIVER, rid);
                in.putExtra(TAG_NAME, rname);
        ...
        friendButton.setOnClickListener(new Button.OnClickListener() {
			...
			public void onClick(View v) {
				Intent geoIntent = new Intent(SelectContact.this, AddFriend.class);
            ...
            runOnUiThread(new Runnable() {
                public void run() {
                    ...
                    ListAdapter adapter = new SimpleAdapter(
                            SelectContact.this, friendsList,
