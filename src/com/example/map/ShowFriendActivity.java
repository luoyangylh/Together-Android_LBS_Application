...
public class ShowFriendActivity extends Activity {
    ...
    private static String url_all_activities = "http://together1.oicp.net:408/together/get_friend_activity.php";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.show_friend_activity);
        
        //final Data data = (Data) getApplication();
        //user_id = data.getID();
        Intent intent = getIntent();
		user_id = intent.getStringExtra("uid");
        Log.d("fid is ", user_id);
    ...
    class LoadAllActivities extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(ShowFriendActivity.this);
        ...
        protected String doInBackground(String... args) {
            ...
            JSONObject json = jParser.makeHttpRequest(url_all_activities, "POST", params);
        ...
        protected void onPostExecute(String file_url) {
            ...
            map = ((MapFragment) getFragmentManager()
                    .findFragmentById(R.id.showfriendactivity)).getMap();
            ...
            map.setOnInfoWindowClickListener(new OnInfoWindowClickListener() {
                ...
                public void onInfoWindowClick(Marker marker) {
    				...
    				if (title.equals("no event")) {
    					Intent intent = new Intent(ShowFriendActivity.this, CreateEvent.class);
    					...
    					Intent intent = new Intent(ShowFriendActivity.this, AttendEvent.class);
    					intent.putExtra("user_id", user_id);
    	                startActivity(intent);
    				}
                }
